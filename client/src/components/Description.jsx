          ...
          <div>
            ...
            <p className='text-gray-600 mb-4'>Easily bring your ideas to life with our free AI 
             ...
             <p className='text-gray-600'>Simply type in a text prompt, and our cutting-edge
               AI will generate high-quality images in second. 
               From product visuals to character desins and portraits,
                even conceots that yet don't exist can be visualised 
                effortlessly. Poweree by advanced Ai techology.</p>
          </div>
        </div>
    </motion.div>
  )
