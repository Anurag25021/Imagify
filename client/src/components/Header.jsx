...
const Header = () => {
  ...
  return (
    ...
    viewport={{once:true}}>
        <motion.div className='teext-stone-500 inline-flex text-center gap-2 
        ...
        <motion.h1 className='text-4xl max-w-[300px] sm:max-w-[590px] 
        ...
        >
            {Array(6).fill('').map((item,index)=>(
                ...
                className='rounded hover:scale-105 transition-all duration-300 cursor-pointer mac-sm:w-10'
